...
def flip_row(poison_sample_index, best_sol, best_instance_data, instance_data, config):
    # global best_sol
    ...
    return best_sol, best_instance_data, instance_data
...
def run(config, instance_data, model=None):
    ...
    for epoch in range(n_epochs):
        ...
        for poison_sample_index in range(no_poison_samples):
            best_sol, best_instance_data, instance_data = flip_row(poison_sample_index, best_sol, best_instance_data, instance_data, config)
