...
cat_poison_data = [0,1,0,1]
# cat_poison_data = [0,1,1,0]
#cat_poison_data = [1,0,0,1] # Why does this one gives a wrong bound with the SOS?
#cat_poison_data = [1,0,1,0]
...
@polyvar num_weights[1:2] cat_weights[1:4] num_poison[1:2] bias t 
