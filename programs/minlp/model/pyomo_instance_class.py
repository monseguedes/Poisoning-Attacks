...
class InstanceData():
    ...
    def inital_sets_size(self):
        ...
        self.categories_dict = get_categorical_feature_to_categories(self.train_dataframe)
        self.no_categories_dict = get_categorical_feature_to_no_categories(self.train_dataframe)
...
def get_categorical_feature_names(df):
    ...
    names : list
    """
    return sorted(set([x.split(":")[0] for x in get_categorical_feature_column_names(df)]))
